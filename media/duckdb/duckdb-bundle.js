...
var DuckDBBundle = (() => {
  ...
  // scripts/duckdb-entry.mjs
  var duckdb_entry_exports = {};
  __export(duckdb_entry_exports, {
    AsyncDuckDB: () => f,
...
return true;`);
  ...
  return __toCommonJS(duckdb_entry_exports);
})();
